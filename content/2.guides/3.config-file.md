...
When you first download Kleeja, the `config.php` file isn't included. The [Kleeja installation process](/getting-started/installation) creates a `config.php` file for you based on the information you provide.
